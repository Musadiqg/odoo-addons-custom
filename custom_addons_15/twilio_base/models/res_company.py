...
class ResCompany(models.Model):
    ...
    twilio_api_key = fields.Char(string="Twilio API Key", required=True)
    twilio_api_secret = fields.Char(string="Twilio API Secret", required=True)
    twilio_outgoing_application_sid = fields.Char(string="Twilio Outgoing Application Sid", required=True)
    twilio_number_id = fields.Many2one('twilio.phone.number', string="Default Twilio Number")
    balance_account = fields.Char(string="Account Balance", compute='_compute_balance_twilio')
